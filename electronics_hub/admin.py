...
class SupplierAdmin(admin.ModelAdmin):
    ...
    list_display = ("name", "email", "country", "city", "street", "house_number")  # Поля для отображения в списке
...
class TradeNodeAdmin(admin.ModelAdmin):
    ...
    list_display = (
        "name", "level", "email", "country", "city", "street", "house_number",
        "product_name", "product_model", "supplier", "debt_to_supplier", "created_at"
    )  # Поля для отображения в списке
    list_filter = ("level", "country", "city", "supplier")  # Фильтры по уровню, стране, городу и поставщику
    search_fields = ("name", "email", "country", "city", "product_name", "product_model")  # Поля для поиска
    ...
    clear_debt_to_supplier.short_description = "Очистить задолженности перед поставщиком"
